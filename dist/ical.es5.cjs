...
var Time = /*#__PURE__*/function () {
  ...
  _createClass(Time, [{
    ...
    value: function fromData(aData, aZone) {
      if (aData) {
        for (var _i2 = 0, _Object$entries = Object.entries(aData); _i2 < _Object$entries.length; _i2++) {
     ...
     */
    function get() {
      if (!_classStaticPrivateFieldSpecGet(this, Time, _epochTime)) {
        _classStaticPrivateFieldSpecSet(this, Time, _epochTime, Time.fromData({
          year: 1970,
          month: 1,
          day: 1,
          hour: 0,
      ...
      return _classStaticPrivateFieldSpecGet(this, Time, _epochTime);
    }
  }, {
    key: "_cmp_attr",
  ...
  _createClass(Timezone, [{
    ...
    function fromData(aData) {
      ...
      if (aData instanceof Component) {
        ...
        for (var _i3 = 0, _OPTIONS = OPTIONS; _i3 < _OPTIONS.length; _i3++) {
          var prop = _OPTIONS[_i3];
          if (aData && prop in aData) {
            this[prop] = aData[prop];
          }
        }
    ...
    key: "utcTimezone",
    get: function get() {
      if (!_classStaticPrivateFieldSpecGet(this, Timezone, _utcTimezone)) {
        _classStaticPrivateFieldSpecSet(this, Timezone, _utcTimezone, Timezone.fromData({
          tzid: "UTC"
        }));
      }
      return _classStaticPrivateFieldSpecGet(this, Timezone, _utcTimezone);
    }
    ...
    key: "localTimezone",
    get: function get() {
      if (!_classStaticPrivateFieldSpecGet(this, Timezone, _localTimezone)) {
        _classStaticPrivateFieldSpecSet(this, Timezone, _localTimezone, Timezone.fromData({
          tzid: "floating"
        }));
      }
      return _classStaticPrivateFieldSpecGet(this, Timezone, _localTimezone);
    }
...
function updateTimezones(vcal) {
  ...
  for (var _i4 = 0, _Object$entries2 = Object.entries(vtimezones); _i4 < _Object$entries2.length; _i4++) {
    var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i4], 2),
      _tzid2 = _Object$entries2$_i[0],
      comp = _Object$entries2$_i[1];
    if (!reqTzid[_tzid2]) {
  ...
  for (var _i5 = 0, _Object$keys = Object.keys(reqTzid); _i5 < _Object$keys.length; _i5++) {
    var _tzid3 = _Object$keys[_i5];
...
function clone(aSrc, aDeep) {
  if (!aSrc || _typeof(aSrc) != "object") {
    ...
    var obj = {};
    for (var _i6 = 0, _Object$entries3 = Object.entries(aSrc); _i6 < _Object$entries3.length; _i6++) {
...
var UtcOffset = /*#__PURE__*/function () {
  ...
  _createClass(UtcOffset, [{
    ...
    value: function fromData(aData) {
      if (aData) {
        for (var _i7 = 0, _Object$entries4 = Object.entries(aData); _i7 < _Object$entries4.length; _i7++) {
...
var VCardTime = /*#__PURE__*/function (_Time) {
  ...
  var _super2 = _createSuper(VCardTime);
  /**
  ...
  function VCardTime(data, zone, icaltype) {
    ...
    _this2 = _super2.call(this, data, zone);
    /**
     * The class identifier.
     * @constant
     * @type {String}
     * @default "vcardtime"
     */
    _defineProperty(_assertThisInitialized(_this2), "icalclass", "vcardtime");
    /**
     * The type name, to be used in the jCal object.
     * @type {String}
     * @default "date-and-or-time"
     */
    _defineProperty(_assertThisInitialized(_this2), "icaltype", "date-and-or-time");
    _this2.icaltype = icaltype || "date-and-or-time";
    return _this2;
  }
  _createClass(VCardTime, [{
    key: "clone",
    value:
    /**
    ...
    function fromDateAndOrTimeString(aValue, aIcalType) {
      ...
      var dt = parts[0],
        tmz = parts[1];
      var splitzone = tmz ? design$1.vcard.value.time._splitZone(tmz) : [];
  ...
  _createClass(RecurIterator, [{
    ...
    value: function init() {
      ...
      if (this.rule.freq == "MONTHLY" && this.has_by_data("BYDAY")) {
        ...
        var _iterator2 = _createForOfIteratorHelper(this.by_data.BYDAY),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var bydow = _step2.value;
        ...
        if (dayOffset < 0) {
          ...
          this.last.day = _daysInMonth2 + dayOffset + 1;
        } else if (this.by_data.BYMONTHDAY[0] > _daysInMonth2) {
    ...
    value: function next_month() {
      ...
      if (this.has_by_data("BYDAY") && this.has_by_data("BYMONTHDAY")) {
        ...
        if (_day2 < 0) {
          _day2 = _daysInMonth3 + _day2 + 1;
        }
        if (_day2 > _daysInMonth3) {
          this.last.day = 1;
        ...
        this.increment_month();
        var _daysInMonth4 = Time.daysInMonth(this.last.month, this.last.year);
        if (this.by_data.BYMONTHDAY[0] > _daysInMonth4) {
          data_valid = 0;
        } else {
    ...
    value: function expand_year_days(aYear) {
      ...
      for (var _i8 = 0, _rules = rules; _i8 < _rules.length; _i8++) {
        var part = _rules[_i8];
      ...
      if (partCount == 0) {
        ...
        var _iterator3 = _createForOfIteratorHelper(this.by_data.BYMONTH),
          _step3;
        try {
        ...
        var _iterator4 = _createForOfIteratorHelper(this.by_data.BYMONTHDAY),
          _step4;
        try {
          for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
            var monthday = _step4.value;
        ...
        var _iterator5 = _createForOfIteratorHelper(this.by_data.BYMONTH),
          _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            var _month2 = _step5.value;
            var _daysInMonth5 = Time.daysInMonth(_month2, aYear);
            var _iterator6 = _createForOfIteratorHelper(this.by_data.BYMONTHDAY),
              _step6;
            try {
              for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                var _monthday = _step6.value;
                if (_monthday < 0) {
                  _monthday = _monthday + _daysInMonth5 + 1;
                }
                t.day = _monthday;
                t.month = _month2;
                t.year = aYear;
        ...
        var _iterator7 = _createForOfIteratorHelper(this.by_data.BYMONTH),
          _step7;
        try {
          for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
            var _month3 = _step7.value;
            var _daysInMonth6 = Time.daysInMonth(_month3, aYear);
            t.year = aYear;
            t.month = _month3;
            t.day = 1;
            t.isDate = true;
            ...
            if (this.has_by_data("BYSETPOS")) {
              var by_month_day = [];
              for (var day = 1; day <= _daysInMonth6; day++) {
                t.day = day;
              ...
              var _iterator8 = _createForOfIteratorHelper(this.by_data.BYDAY),
                _step8;
              try {
                for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                  var coded_day = _step8.value;
                  var bydayParts = this.ruleDayOfWeek(coded_day);
                  var pos = bydayParts[0];
                  var dow = bydayParts[1];
                  var month_day = void 0;
                  var first_matching_day = (dow + 7 - first_dow) % 7 + 1;
                  var last_matching_day = _daysInMonth6 - (last_dow + 7 - dow) % 7;
                  if (pos == 0) {
                    for (var _day3 = first_matching_day; _day3 <= _daysInMonth6; _day3 += 7) {
                      this.days.push(doy_offset + _day3);
                    }
                  } else if (pos > 0) {
                    month_day = first_matching_day + (pos - 1) * 7;
                    if (month_day <= _daysInMonth6) {
        ...
        var _iterator9 = _createForOfIteratorHelper(expandedDays),
          _step9;
        try {
          for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
            var _day4 = _step9.value;
        ...
        var _iterator10 = _createForOfIteratorHelper(_expandedDays),
          _step10;
        try {
          for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
            var _day5 = _step10.value;
        ...
        var _iterator11 = _createForOfIteratorHelper(_expandedDays2),
          _step11;
        try {
          for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
            var _day6 = _step11.value;
    ...
    value: function is_day_in_byday(tt) {
      if (this.by_data.BYDAY) {
        var _iterator13 = _createForOfIteratorHelper(this.by_data.BYDAY),
          _step13;
        try {
    ...
    value: function check_contract_restriction(aRuleType, v) {
      ...
      if (aRuleType in this.by_data && ruleMapValue == RecurIterator.CONTRACT) {
        ...
        var _iterator14 = _createForOfIteratorHelper(ruleType),
          _step14;
        try {
          for (_iterator14.s(); !(_step14 = _iterator14.n()).done;) {
            var bydata = _step14.value;
            if (bydata == v) {
              pass = true;
              break;
            }
...
var Recur = /*#__PURE__*/function () {
  ...
  _createClass(Recur, [{
    ...
    value: function toJSON() {
      ...
      for (var _i9 = 0, _Object$entries5 = Object.entries(this.parts); _i9 < _Object$entries5.length; _i9++) {
        var _Object$entries5$_i = _slicedToArray(_Object$entries5[_i9], 2),
          k = _Object$entries5$_i[0],
          kparts = _Object$entries5$_i[1];
    ...
    value: function toString() {
      ...
      for (var _i10 = 0, _Object$entries6 = Object.entries(this.parts); _i10 < _Object$entries6.length; _i10++) {
...
var icalValues = extend(commonValues, {
  ...
  recur: {
    ...
    toICAL: function toICAL(data) {
      var str = "";
      for (var _i11 = 0, _Object$entries7 = Object.entries(data); _i11 < _Object$entries7.length; _i11++) {
...
stringify.property = function (property, designSet, noFold) {
  ...
  for (var _i12 = 0, _Object$entries8 = Object.entries(params); _i12 < _Object$entries8.length; _i12++) {
    var _Object$entries8$_i = _slicedToArray(_Object$entries8[_i12], 2),
      paramName = _Object$entries8$_i[0],
      value = _Object$entries8$_i[1];
    if (designSet.propertyGroups && paramName == 'group') {
      continue;
    }
    var _multiValue = paramName in designSet.param && designSet.param[paramName].multiValue;
    if (_multiValue && Array.isArray(value)) {
      if (designSet.param[paramName].multiValueSeparateDQuote) {
        _multiValue = '"' + _multiValue + '"';
      }
      value = value.map(stringify._rfc6868Unescape);
      value = stringify.multiValue(value, _multiValue, "unknown", null, designSet);
    } else {
...
var Component = /*#__PURE__*/function () {
  ...
  _createClass(Component, [{
    ...
    value: function getTimeZoneByID(tzid) {
      ...
      var _iterator15 = _createForOfIteratorHelper(zones),
        _step15;
      try {
        for (_iterator15.s(); !(_step15 = _iterator15.n()).done;) {
          var zone = _step15.value;
  ...
  _createClass(RecurExpansion, [{
    ...
    value: function _extractDates(component, propertyName) {
      ...
      for (var i = 0, len = props.length; i < len; i++) {
        var _iterator16 = _createForOfIteratorHelper(props[i].getValues()),
          _step16;
        try {
...
var ComponentParser = /*#__PURE__*/function () {
  ...
  function ComponentParser(options) {
    ...
    for (var _i13 = 0, _Object$entries9 = Object.entries(options); _i13 < _Object$entries9.length; _i13++) {
      var _Object$entries9$_i = _slicedToArray(_Object$entries9[_i13], 2),
